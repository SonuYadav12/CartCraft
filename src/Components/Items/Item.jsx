...
const Item = ({ id, name, image, oldprice, newprice }) => {
  return (
    <div key={id} className="p-2 bg-gradient-to-t from bg-gray-100 to-white rounded-xl shadow-black shadow-lg cursor-pointer w-80 flex flex-col items-center justify-center">
